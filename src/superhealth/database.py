...
def upsert_daily_health(conn: sqlite3.Connection, dh: DailyHealth):
    ...
    conn.execute(
        ...
        INSERT INTO daily_health (
            ...
            sleep_total_seconds=COALESCE(excluded.sleep_total_seconds, sleep_total_seconds),
            sleep_deep_seconds=COALESCE(excluded.sleep_deep_seconds, sleep_deep_seconds),
            sleep_light_seconds=COALESCE(excluded.sleep_light_seconds, sleep_light_seconds),
            sleep_rem_seconds=COALESCE(excluded.sleep_rem_seconds, sleep_rem_seconds),
            sleep_awake_seconds=COALESCE(excluded.sleep_awake_seconds, sleep_awake_seconds),
            sleep_score=COALESCE(excluded.sleep_score, sleep_score),
            stress_average=COALESCE(excluded.stress_average, stress_average),
            stress_max=COALESCE(excluded.stress_max, stress_max),
            stress_rest_seconds=COALESCE(excluded.stress_rest_seconds, stress_rest_seconds),
            stress_low_seconds=COALESCE(excluded.stress_low_seconds, stress_low_seconds),
            stress_medium_seconds=COALESCE(excluded.stress_medium_seconds, stress_medium_seconds),
            stress_high_seconds=COALESCE(excluded.stress_high_seconds, stress_high_seconds),
            hr_resting=COALESCE(excluded.hr_resting, hr_resting),
            hr_min=COALESCE(excluded.hr_min, hr_min),
            hr_max=COALESCE(excluded.hr_max, hr_max),
            hr_avg7_resting=COALESCE(excluded.hr_avg7_resting, hr_avg7_resting),
            bb_highest=COALESCE(excluded.bb_highest, bb_highest),
            bb_lowest=COALESCE(excluded.bb_lowest, bb_lowest),
            bb_charged=COALESCE(excluded.bb_charged, bb_charged),
            bb_drained=COALESCE(excluded.bb_drained, bb_drained),
            bb_at_wake=COALESCE(excluded.bb_at_wake, bb_at_wake),
            spo2_average=COALESCE(excluded.spo2_average, spo2_average),
            spo2_lowest=COALESCE(excluded.spo2_lowest, spo2_lowest),
            spo2_latest=COALESCE(excluded.spo2_latest, spo2_latest),
            resp_waking_avg=COALESCE(excluded.resp_waking_avg, resp_waking_avg),
            resp_highest=COALESCE(excluded.resp_highest, resp_highest),
            resp_lowest=COALESCE(excluded.resp_lowest, resp_lowest),
            ...
            floors_ascended=COALESCE(excluded.floors_ascended, floors_ascended),
            hrv_last_night_avg=COALESCE(excluded.hrv_last_night_avg, hrv_last_night_avg),
            hrv_last_night_5min_high=COALESCE(excluded.hrv_last_night_5min_high, hrv_last_night_5min_high),
            hrv_weekly_avg=COALESCE(excluded.hrv_weekly_avg, hrv_weekly_avg),
            hrv_baseline_low=COALESCE(excluded.hrv_baseline_low, hrv_baseline_low),
            hrv_baseline_high=COALESCE(excluded.hrv_baseline_high, hrv_baseline_high),
    ...
    new = dict(new_row) if new_row else {}
